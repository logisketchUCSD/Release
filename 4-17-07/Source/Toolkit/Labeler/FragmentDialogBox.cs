...
namespace Labeler
{
	...
	public class FragmentDialogBox : System.Windows.Forms.Form
	{
		...
		public FragmentDialogBox(Sketch.Stroke[] strokes, LabelerPanel labelerPanel, CommandManager CM)
		{
			...
			this.fragStrokeToCorners = new Hashtable();
			foreach (Sketch.Stroke stroke in this.strokes)
			{
				ArrayList val = (ArrayList)this.labelerPanel.StrokeToCorners[stroke];
				
				if (val != null)
					fragStrokeToCorners.Add(stroke, new ArrayList(val));
			}
		...
		private void InitializeComponent()
		{
			...
			this.fragPanelToolbar.Size = new System.Drawing.Size(448, 49);
