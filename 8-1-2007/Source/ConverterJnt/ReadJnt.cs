...
namespace ConverterJnt
{
    ...
    public class ReadJnt
    {
        ...
        public static Sketch.Stroke StripStrokeData(Microsoft.Ink.Stroke inkStroke, Matrix transf, bool shift)
        {
            ...
            substroke.XmlAttrs.PenWidth = penWidth;
            substroke.XmlAttrs.PenHeight = penHeight;
            substroke.XmlAttrs.Raster = raster;
            //substroke.XmlAttrs.X = x;
            //substroke.XmlAttrs.Y = y;
            //substroke.XmlAttrs.P1 = p1;
            //substroke.XmlAttrs.P2 = p2;
            ...
            for (i = 0; i < length; i++)
            {
                ...
                currX = Convert.ToSingle(xData[i]);
                currY = Convert.ToSingle(yData[i]);
                if (currX < minX)
                    minX = currX;
                if (currX > maxX)
                    maxX = currX;
                ...
                toAdd.XmlAttrs.X = currX;
                toAdd.XmlAttrs.Y = currY;
            ...
            substroke.XmlAttrs.X = minX;
            substroke.XmlAttrs.Y = minY;
            substroke.XmlAttrs.Width = maxX - minX;
            substroke.XmlAttrs.Height = maxY - minY;
