...
namespace Labeler.CommandList
{
	...
	public class RemoveLabelCmd : Command
	{
		...
		/// </summary>
		private Dictionary<int, Sketch.Substroke> mIdToSubstroke;
		...
		public RemoveLabelCmd(Sketch.Sketch sketch, List<Substroke> substrokes, Microsoft.Ink.Strokes inkStrokes, 
			Dictionary<int, Sketch.Substroke> mIdToSubstroke, string label, DomainInfo domainInfo)
		{
			this.sketch = sketch;
		...
		public override void Execute()
		{
			...
			foreach (Microsoft.Ink.Stroke stroke in this.inkStrokes)
			{
				...
				string[] remainingLabels = this.mIdToSubstroke[stroke.Id].GetLabels();
